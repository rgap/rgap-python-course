...
# 6. List Comprehensions for Iteration and Transformation
# List comprehensions provide a concise way to iterate over a list and apply transformations or filters.
uppercase_colors = [color.upper() for color in colors]
print(uppercase_colors)  # Outputs: ['RED', 'GREEN', 'BLUE']
