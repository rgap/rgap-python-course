# Python Version: Functions have been a fundamental part of Python since version 1.0 (January 1994).

# Basic Function in Python
# Functions are reusable blocks of code designed to perform a specific task.
# They help in organizing code, making it more modular, maintainable, and reusable.
...
# Parameters allow you to pass data to a function, making it more dynamic and reusable.
def greet_user(name):
